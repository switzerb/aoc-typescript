   ...
   function execute(s){
     ...
     for( var i = 0; i < 500; i++) {
       for (var j = 0; j < instructions.length;j++) {
         ...
         try {
           wires[wire] = doInstruction(parts);
         } catch (e) {}
       }
       if ('a' in wires) {
         return wires.a;
